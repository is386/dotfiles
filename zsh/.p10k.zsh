...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_{ETC,HOME,HOME_SUBFOLDER,DEFAULT,NOT_WRITABLE}_CONTENT_EXPANSION='%4(~|…/%3~|%~)'

  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%F{$white}%n%f%F{$grey}@%m%f"
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{$blue}%n%f"
  ...
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${VCS_STATUS_LOCAL_BRANCH:+[${VCS_STATUS_LOCAL_BRANCH}]}'
